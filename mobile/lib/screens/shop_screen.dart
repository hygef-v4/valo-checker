...
class _ShopScreenState extends State<ShopScreen> {
                  ...
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Stream Demo Video: ${skin.videoUrl}')),
                      );
                    },
                    icon: const Icon(Icons.play_circle_fill, color: Colors.white),
                    label: const Text('WATCH DEMO VIDEO', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                  ),
                ),
              ],
            ],
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Row(
                children: [
                  _buildCurrencyPill('V', '${_profile?.vp ?? 0}'),
                  const SizedBox(width: 8),
                  _buildCurrencyPill('R', '${_profile?.rad ?? 240}'),
                  const SizedBox(width: 8),
                  _buildCurrencyPill('K', '${_profile?.kc ?? 3809}'),
                ],
              ),
            ],
          ),
  ...
  Widget _buildCurrencyPill(String symbol, String amount) {
    return Container(
  ...
  Widget _buildAccountsMainTab() {
    final rankText = _rankInfo != null ? '${_rankInfo!.currentTierName} - ${_rankInfo!.currentRR} RR' : 'Bronze 2 - 52 RR';
                  ...
                  Stack(
                    children: [
                      ClipRRect(
                        borderRadius: BorderRadius.circular(12),
                        child: CachedNetworkImage(
                          imageUrl: _profile?.cardIcon ?? 'https://media.valorant-api.com/playercards/9fb348bc-4141-423b-a63e-cbca722a4d09/displayicon.png',
                          width: 70,
                          height: 70,
                          fit: BoxFit.cover,
                        ),
